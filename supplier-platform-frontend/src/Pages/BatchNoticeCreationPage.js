...
import { Table, Button, Form, Select, DatePicker, Typography, Card, Popconfirm, Input, Upload, Empty, Space, Tooltip, Image, InputNumber, Modal, Row, Col, Switch, Alert, Progress, Checkbox } from 'antd';
...
const BatchNoticeCreationPage = () => {
    ...
    const handleSubmitAll = async () => {
        ...
        messageApi.loading({ content: '正在处理数据并上传文件...', key: 'submitting', duration: 0 });
            ...
            try {
                    ...
                    return mapWithConcurrency(fileList, MAX_FILE_UPLOAD_CONCURRENCY, async file => {
                        try {
                            ...
                            if (file.originFileObj && !file.url) {
                                ...
                                const uploaded = await retryAsync(() => uploadFileToCos(uploadFile, uploadName));
                                return {
                                    uid: file.uid,
                                    name: uploadName,
                                    status: 'done',
                ...
                return {
                    ...
                    sd_notice: {
                        ...
                        details: details,
                        requireSupplierEvidenceFiles: !!globalSettings.requireSupplierEvidenceFiles,
                    },
                    history: [],
                };
            } catch (error) {
            ...
            <Card style={{ marginBottom: 16 }}>
                ...
                <Form form={globalForm} layout="inline">
                    ...
                    <Form.Item
                        ...
                        initialValue={false}
                    >
                        <Checkbox disabled={!!globalSettings}>要求供应商提交完成证据时必须上传图片/视频或附件</Checkbox>
                    </Form.Item>
                    <Form.Item>
                        {globalSettings ? (
